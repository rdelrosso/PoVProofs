...
class LoginActivity : AppCompatActivity() {
    ...
    private fun onLoginSuccess() {
        // successful login ends this activity, bringing the user back to the listings activity
        finish()
    }
    ...
    private fun login(createUser: Boolean) {
        ...
        if (createUser) {
            // register a user using the Realm App we created in the ListingManager class
            listingsApp.emailPasswordAuth.registerUserAsync(username, password) {
